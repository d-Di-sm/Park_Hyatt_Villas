...
export const galleryImages = [
  { src: '/images/VSTA MAR.png', alt: 'Villa exterior at dusk' },
  { src: '/images/SALA_01.png', alt: 'Living room' },
  { src: '/images/DINNING.png', alt: 'Dining room' },
  { src: '/images/POOL.png', alt: 'Pool' },
  { src: '/images/MSTR_01.png', alt: 'Master bedroom' },
  { src: '/images/TERRAZA 01.png', alt: 'Terrace view' },
];
...
export const proximity = [
  { name: 'Anima Village', dist: '3 min' },
  { name: 'Soho House Los Cabos', dist: '5 min' },
  { name: 'Cabo San Lucas Downtown', dist: '35 min' },
  { name: 'The Arch of Cabo San Lucas', dist: '40 min' },
  { name: 'SJD Airport', dist: '50 min' },
];
